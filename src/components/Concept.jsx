        ...
        <div style={{ width: '100%', minHeight: '100vh', background: '#fff' }}>
            ...
            <div style={heroStyles.hero}>
                ...
                <div style={heroStyles.content}>
                    <h1 style={heroStyles.title}>CONCEPT</h1>
                    <div style={heroStyles.subtitle}>Buren voor Buren Tienen is een zorgnetwerk, een instrument voor buurtgerichte zorg.</div>
                </div>
            </div>
            <div style={mainStyles.wrapper}>
                ...
                <svg style={mainStyles.svgKrulWideMiddle} viewBox="0 0 1600 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10,110 Q400,10 800,60 T1590,30" stroke="#e2725b" strokeWidth="7" fill="none" />
                </svg>
                <div style={mainStyles.section}>
                    <div style={mainStyles.heading}>2 Buurtgerichte zorg</div>
                    <p style={mainStyles.paragraph}>Met buurtgerichte zorg wordt het geheel van inspanningen genoemd om zorgzame buurten te creëren: buurten waar de inwoners elkaar ondersteunen en zorg dragen voor elkaar, bijgestaan door professionele zorgverstrekkers en dienstverleners.</p>
                ...
                <svg style={mainStyles.svgKrulWideBottom} viewBox="0 0 1600 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10,110 Q400,10 800,60 T1590,30" stroke="#e2725b" strokeWidth="7" fill="none" />
                </svg>
                <div style={mainStyles.section}>
                    <div style={mainStyles.heading}>3 Functies van buurtgerichte zorg</div>
                    <p style={mainStyles.paragraph}>In de professionele discussie over BZ wordt meer en meer verwezen naar &lsquo;de acht functies van buurtzorgregie&rsquo; die onderscheiden worden door de Vereniging van Vlaamse Steden en Gemeenten (Dewulf &amp; Verlinden 2019). De tekst wordt meer en meer een gezamenlijk referentiekader voor buurtzorginitiatieven. Buren voor Buren Tienen sluit zich hier graag bij aan, in de mate van het mogelijke, want onze middelen zijn beperkt.</p>
                    <p style={mainStyles.paragraph}>We gaan ervan uit dat een gemeenschappelijk referentiekader ook de lokale samenwerking met vooral de professionele organisaties kan stimuleren, of in elk geval de eerste contacten kunnen versoepelen.</p>
                    <div style={mainStyles.subheading}>3.1 Buurtanalyse</div>
                    <p style={mainStyles.paragraph}>Elke buurt is anders en de werking moet daaraan worden aangepast. Wij kennen onze buurten echter al vrij goed, daarom kunnen we aan de slag voor er een formele analyse gebeurt. Buurtanalyse is overigens een permanent proces.</p>
                    <div style={mainStyles.subheading}>3.2 Partnerschappen en samenwerking tot stand brengen</div>
                    <p style={mainStyles.paragraph}>&quot;In het bijzonder voor mensen met een kwetsbaarheid of in een maatschappelijk kwetsbare positie is het belangrijk dat alle zorgactoren hun hulp- en dienstverlening op elkaar afstemmen en complementair aanbieden. Dit voorkomt verkokerde hulpverlening&quot; (Dewulf &amp; Verlinden 2019, p. 31)</p>
                    <p style={mainStyles.paragraph}>Naast de zorgorganisaties (waarvan we er veel via ELZOH en/of het platform van Verbonden in ZOHrg kunnen bereiken) ook vertegenwoordigers van andere levensdomeinen in de buurt: verenigingen, scholen, wijkagenten, woonactoren.</p>
                    <div style={mainStyles.subheading}>3.3 Sensibiliseren en informeren</div>
                    <p style={mainStyles.paragraph}>Mensen met een ondersteuningsvraag moeten weten waar ze terecht kunnen voor welk soort vraag en hoe ze dat moeten doen. Dat wordt &lsquo;zorggeletterdheid&rsquo; genoemd. Om de zorggeletterdheid van de hulpvragers te verhogen, moeten ook de vrijwilligers zo goed mogelijk op de hoogte zijn of gebracht worden van het aanbod, inz. op het gebied van zorg (de sociale kaart). Onze vrijwilligers kunnen altijd een beroep doen op de stadscoördinator (OCMW) wanneer ze bepaalde informatie niet kunnen geven, maar toch zullen we grote aandacht moeten besteden aan vorming.</p>
                    <div style={mainStyles.subheading}>3.4 Sociale netwerken uitbouwen</div>
                    <p style={mainStyles.paragraph}>Mensen met weinig netwerken (vooral de meest kwetsbaren) hebben daar op vele manieren last van. Sociale netwerken dragen dan ook bij tot de levenskwaliteit van individuen. Netwerken met elkaar in verband brengen versterkt bovendien de sociale cohesie en de solidariteit, en op die manier ook weer de individuen.</p>
                    <div style={mainStyles.subheading}>3.5 Sociaal gewaardeerde rollen tot stand brengen</div>
                    <p style={mainStyles.paragraph}>Mensen hebben het vaak moeilijk met hulp vragen en krijgen. Dat verandert wanneer ze ook in een geverspositie belanden, wanneer ze een functie krijgen in een netwerk en daar ook waardering voor krijgen. Het laat mensen weer &lsquo;in hun kracht komen&rsquo;  (empoweren), wat in het algemeen bijdraagt tot integratie en inclusie. Buren voor Buren kan mensen in het eigen netwerk een plaats geven of daarvoor bemiddelen bij samenwerkende netwerken. Op het empoweren willen we in elk geval sterk inzetten.</p>
                    <div style={mainStyles.subheading}>3.6 Zorgnoden detecteren</div>
                    <p style={mainStyles.paragraph}>Doordat mensen niet makkelijk hulp vragen, blijven de problemen vaak onder de radar. Als we willen dat iedereen die ondersteuning nodig heeft, die ook krijgt, moeten we actief op zoek gaan naar zorgnoden, bv. door bij de mensen aan huis te gaan informeren (&lsquo;outreachen&rsquo;). Maar ook partners (2) of leden van de sociale netwerken (4) kunnen signalen detecteren.</p>
                    <div style={mainStyles.subheading}>3.7 Toeleiding naar de juiste zorg en ondersteuning</div>
                    <p style={mainStyles.paragraph}>Mensen aanvaarden of geloven niet altijd gemakkelijk dat ze hulp nodig hebben, of als ze dat wel doen, zetten ze niet altijd de nodige stappen. Anderzijds moeten hulpverleners, vrijwilligers ook hun eigen verlegenheid overwinnen om aan te geven dat er een probleem is en om ervoor te zorgen dat er effectief hulp gevraagd wordt.</p>
                    <div style={mainStyles.subheading}>3.8 Beleidsadvisering vanuit de buurt</div>
                    <p style={mainStyles.paragraph}>Buurtwerking levert heel wat informatie op over de noden en vragen van de buurtbewoners, en niet enkel over zorg en welzijn, maar ook over wonen, vrije tijd, mobiliteit enz. Om de toestand te verbeteren, moet het beleid ingelicht worden en uitgenodigd om er iets aan te doen. Door de verankering van Buren voor Buren in de stedelijke organisatie, via de stadscoördinator, zou de informatieoverdracht geen probleem mogen zijn. Of buurten ook voorstellen kunnen uitwerken ter verbetering, zal afhangen van hun mogelijkheden (bv. buurten met buurtcomités of belangengroeperingen zullen dat makkelijker kunnen).</p>
                </div>
