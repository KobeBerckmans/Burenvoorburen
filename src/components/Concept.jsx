            ...
            <div style={mainWrapperResponsive}>
                ...
                <Accordion title="3 Functies van buurtgerichte zorg">
                    <div style={mainStyles.section}>
                        ...
                        <p style={mainStyles.paragraph}>Mensen hebben het vaak moeilijk met hulp vragen en krijgen. Dat verandert wanneer ze ook in een geverspositie belanden, wanneer ze een functie krijgen in een netwerk en daar ook waardering voor krijgen. Het laat mensen weer &apos;in hun kracht komen&apos;  (empoweren), wat in het algemeen bijdraagt tot integratie en inclusie. Buren voor Buren kan mensen in het eigen netwerk een plaats geven of daarvoor bemiddelen bij samenwerkende netwerken. Op het empoweren willen we in elk geval sterk inzetten.</p>
